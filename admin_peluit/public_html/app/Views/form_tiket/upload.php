    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Upload Document</div>
            </div>
        </div>
                    ...
                    <div class="card flex-grow-1 ">
                        ...
                        <div class="card-body">
                            <div class="form-group row align-items-center">
                                <label class="col-md-12 text-md-left text-left">Jenis Dokumen</label>
                                <div class="col-lg-12 col-md-12">
                                    <select class="form-control" id="jenis">
                                        <option value="0">SAKIP</option>
                                        <option value="1">LAKIP</option>
                                        <option value="2">INFORMASI</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
                                <label class="col-md-12 text-md-left text-left">Edisi</label>
                                <div class="col-lg-12 col-md-12">
                                    <input type="text" id="edisi" class="form-control">
                                    <small class="text-info">Contoh : 2023</small>
                                </div>
                            </div>
                            ...
                            <hr>
                            <div class="form-group row align-items-center">
                                <label class="col-md-12 text-md-left text-left">Berkas Upload</label>
                                <div class="col-lg-12 col-md-12">
                                    <input type="file" id="dokumen" class="form-control" accept="application/pdf">
                                    <small class="text-info">*Berkas harus pdf</small><br>
                                    <small class="text-info">*Berkas dijadikan 1 pdf</small><br>
                                    <small class="text-info">*Kapasitas max 5 MB</small><br>
                                    <small class="text-info">*Sudah ada tanda tangan dan stampel</small>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
...
function remove_invalid() {
    document.getElementById("edisi").classList.remove("is-invalid");
    document.getElementById("dokumen").classList.remove("is-invalid");
...
function add_tiket() {
    ...
    if (document.getElementById('edisi').value == "") {
        document.getElementById('edisi').classList.add("is-invalid");
        document.getElementById("edisi").focus();
        Swal.fire({
            icon: 'error',
            title: 'Gagal...',
            text: 'Form Edisi Kosong !'
        });
    ...
    } else if (document.getElementById('dokumen').value == "") {
        document.getElementById('dokumen').classList.add("is-invalid");
        document.getElementById("dokumen").focus();
        Swal.fire({
            icon: 'error',
            title: 'Gagal...',
            text: 'Form Dokumen Upload Kosong !'
        });
    } else if (validasi_document() == false) {
        document.getElementById('dokumen').classList.add("is-invalid");
        document.getElementById("dokumen").focus();
        Swal.fire({
            icon: 'error',
            title: 'Gagal...',
            text: 'Dokumen Upload harus PDF dan kurang dari 5 MB !'
        });
        ...
        $.ajax({
            url: "<?= base_url() ?>/<?= session()->get('role') ?>/tiket/set_upload",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
...
function validasi_document() {
    var fi = document.getElementById('dokumen');
    var hasil = true;
    if (fi.files.length > 0) {
        var count = 0;
        var total = fi.files.length;
        while (count < fi.files.length) {
            ...
            // console.log(fi.files.item(count));
            var size = (fsize / 1024 / 1024).toFixed(2);
            if (ekstensi.includes('pdf') && size < 5) {
                hasil = true;
            } else {
                hasil = false;
                break;
