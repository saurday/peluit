                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <div class="tab-pane fade" id="profile4" role="tabpanel"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="nik">Jenis Dokumen</label>
                                        ...
                                        <div class="tab-pane fade show" id="file4" role="tabpanel"
                                            ...
                                            <button type="button"
                                                onclick="window.open('<?= base_url() ?>/public/assets/berkas/upload/<?= $berkas_upload ?>','_blank')"
                                                class="btn btn-primary btn-icon icon-left">
                                                <i class="fas fa-file-download"></i> Unduh Berkas Upload
                                            </button>
                                        </div>
