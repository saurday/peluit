                                    ...
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#profile4"
                                                role="tab" aria-controls="profile" aria-selected="false">Detail Alat</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <div class="tab-pane fade" id="profile4" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <!-- <label>Alat</label> -->
                                                <table id="example" class="table table-sm nowrap" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            <th>Nama Alat</th>
                                                            <th>Merk</th>
                                        ...
                                        <!-- <div class="activity">
                                            ...
                                            <div class="activity-detail">
                                                <div class="mb-2">
                                                    ...
                                                    <span class="bullet text-success"></span>
                                                    <a class="text-job" href="#">Selesai</a>
                                        ...
                                        <div class="activity">
                                            ...
                                            <div class="activity-detail">
                                                <div class="mb-2">
                                                    ...
                                                    <a class="text-job" href="#">Proses</a>

                                                </div>
                                                <p>Verifikasi Tanggal Pelaksanaan</p>
                                            </div>
                                        </div>
                                        <div class="activity">
                                            <div class="activity-icon bg-primary text-white shadow-primary">
                                            ...
                                            <div class="activity-detail">
                                                ...
                                                <p>Verifikasi Tempat Pelaksanaan</p>
                                            </div>
                                        </div>
                                        <div class="activity">
                                            <div class="activity-icon bg-primary text-white shadow-primary">
                                        ...
                                        <div class="activity">
                                            ...
                                            <div class="activity-detail">
                                                <div class="mb-2">
                                                    ...
                                                    <span class="bullet text-danger"></span>
                                                    <a class="text-job" href="#">Ditolak</a>
