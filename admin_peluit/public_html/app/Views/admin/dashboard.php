                    ...
                    <div class="card-stats">
                        ...
                        <div class="card-stats-items">
                            <div class="card-stats-item">
                                <div class="card-stats-item-count"><?= $count_verifikator ?></div>
                                <div class="card-stats-item-label">Verifikator</div>
                            </div>
                            <div class="card-stats-item">
                                <div class="card-stats-item-count"><?= $count_operator ?></div>
                                <div class="card-stats-item-label">Operator</div>
                            </div>
                            <div class="card-stats-item">
                                <div class="card-stats-item-count"><?= $count_magang ?></div>
