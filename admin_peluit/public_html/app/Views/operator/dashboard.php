            ...
            <div class="col-lg-4 col-md-4 col-sm-12 d-flex w-100 ">
                <div class="card card-statistic-2 flex-grow-1">
                    <div class="card-stats">
                        <div class="card-stats-title">Jumlah Pengguna
                        </div>
                        <div class="card-stats-items">
                            <div class="card-stats-item">
                                <div class="card-stats-item-count" id="jumlah_pembimbing">0</div>
                                <div class="card-stats-item-label">Pembimbing</div>
                            </div>
                            <div class="card-stats-item">
                                <div class="card-stats-item-count" id="jumlah_operator">0</div>
                                <div class="card-stats-item-label">Operator</div>
                            </div>
                            <div class="card-stats-item">
                                <div class="card-stats-item-count" id="jumlah_magang">0</div>
                                <div class="card-stats-item-label">Magang</div>
                            </div>
                        </div>
                    </div>
...
function tiket_count_user() {
    $.ajax({
        ...
        success: function(data) {
            // console.log(data);
            document.getElementById("jumlah_pembimbing").innerHTML = data["count_pembimbing"];
            document.getElementById("jumlah_operator").innerHTML = data["count_operator"];
            document.getElementById("jumlah_magang").innerHTML = data["count_magang"];
            document.getElementById("jumlah_total").innerHTML = data["count_all"];
